...
load_remote_data <- function() {
    read_sheet("1NNo23idWdFofp5LbBS_3S6EQfzgbe1sVgr2GRAjucA0")
}
...
m <- leaflet() %>%
    ...
    addMarkers(lng=remote_data$lon, lat=remote_data$lat, popup=remote_data$details) #to-do: make this interactive
m  # Print the map
